<div class="contacts">
  <h1>Contacts</h1>
  <ul class="list">
    <li class="first">Tel: <a href="tel:+11634556897">+1(163)4556897</a></li>
    <li>github: <a href="https://github.com/Ameglessa1986">Anastasiya</a></li>
    <li class="last">email: <a href="mailto:Ameglessa@localhost.host">Ameglessa@localhost.host</a></li>
  </ul>
  <iframe
    ...
    frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="450" height="380">
  </iframe>
</div>